...
fashin_dataset = tf.keras.datasets.fashion_mnist
(train_images, train_labels),(test_images, test_labels) = fashin_dataset.load_data()
...
for i in range(num_images):
  ...
  plot_image(i, predictions[i]*255.0, test_labels, test_images*255.0)
